...
load("simout_sptm_supp1_05242021.RData")
...
ggplot2::ggsave("simulation_supp_spacetime_1.pdf", result, width = 15.2, height = 10)
...
load("simout_sptm_supp2_05242021.RData")
...
ggplot2::ggsave("simulation_supp_spacetime_2.pdf", result, width = 15.2, height = 10)
