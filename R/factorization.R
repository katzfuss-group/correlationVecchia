...
###
###   Overview: This script includes R functions to compute a Cholesky factor of a user-defined covariance matrix stably.
###
###   Contents:
###     factorize / modify
###
###   Note: Simply speaking, modify() = factorize() * factorize()^t
###
####################################################################################
