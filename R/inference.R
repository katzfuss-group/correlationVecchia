...
###
###   Overview: This script includes several R functions to estimate parameters using the Fisher-scoring approach.
###
###   Contents: 
###     fit_scaled
###     fit_scaled_spacetime_range / .fit_scaled_spacetime_baseline_range / .fit_scaled_spacetime_cvecchia_range / .fit_scaled_spacetime_exactgp_range
###
####################################################################################
