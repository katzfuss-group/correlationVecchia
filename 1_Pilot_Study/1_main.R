...
source("1_code/2_vecchia_specify_adjusted.R")
...
source("1_code/3_kldiv.R") 
# Call the simulation function
source("1_code/4_simulation.R") 
...
sim1  <- simulation(ordering = "maxmin", which.coord = NULL, conditioning = "NN", m = 10, scale.aniso = 10, n = 15^2, range = 0.1, covparms = c(1, 0.1, 0.5), nugget = 0)
...
for(i in 1){
  # last
  quilt.plot(approx[[i]]$locsord,floor(log(1:n)),col=heat.colors(99), xaxs="r",yaxs='r',
             main = "Cond. set of the n-th obs.")
  points(approx[[i]]$locsord[n,1],approx[[i]]$locsord[n,2],cex=2,pch='x')
  ...
  points(approx[[i]]$locsord[as.integer(n/2),1],approx[[i]]$locsord[as.integer(n/2),2],cex=2,pch='x')
...
sim.xycoord <- repeated_simulation(ordering = "coord", which.coord = c(1, 2), conditioning = "NN", 
                                   ms = cand.m, scales = cand.scale,
                                   n = 30^2, range = 0.1, covparms = c(1, 0.1, 0.5), nugget = 0)
...
kls.xycoord.euclidean   <- sim.xycoord$kls[[1]][,3]
# kls.xycoord.corr        <- sim.xycoord$kls[[2]][,3] # non-sense

vis.list  <- c(kls.maxmin.euclidean, kls.maxmin.corr, kls.xcoord.euclidean, kls.ycoord.euclidean, kls.xycoord.euclidean)
...
lines(cand.m, log10(kls.xycoord.euclidean), type = "l", col = 5, lty = 5, lwd = 3)
legend("bottomleft", 
       legend=c("maxmin + Euclidean", "maxmin + correlation",
                "x-coord + Euclidean", "y-coord + Euclidean",
                "(x+y)-coord + Euclidean"),
       col=1:5, lty=1:5, lwd = 3, cex=1.5)
...
plot(cand.scale, log10(kls.maxmin.euclidean), type = "l", col = 1, lty = 1, lwd = 3,
     ylim = c(log10(min.kls), log10(max.kls)), 
     xlab = "scale.aniso", ylab = "log10(KL)", main = "", cex.lab=1.5)
...
lines(cand.scale, log10(kls.xycoord.euclidean), type = "l", col = 5, lty = 5, lwd = 3)
legend("bottomleft", 
       legend=c("maxmin + Euclidean", "maxmin + correlation",
                "x-coord + Euclidean", "y-coord + Euclidean",
                "(x+y)-coord + Euclidean"),
       col=1:5, lty=1:5, lwd = 3, cex=1.4)
...
kls.xycoord.euclidean   <- sim.xycoord$kls[[1]][7,]
# kls.xycoord.corr        <- sim.xycoord$kls[[2]][7,] # non-sense
...
plot(cand.scale, log10(kls.maxmin.euclidean), type = "l", col = 1, lty = 1, lwd = 3,
     ylim = c(log10(min.kls), log10(max.kls)), 
     xlab = "scale.aniso", ylab = "log10(KL)", main = NULL, cex.lab=1.5)
lines(cand.scale, log10(kls.maxmin.corr), type = "l", col = 2, lty = 2, lwd = 3)
lines(cand.scale, log10(kls.xcoord.euclidean), type = "l", col = 3, lty = 3, lwd = 3)
lines(cand.scale, log10(kls.ycoord.euclidean), type = "l", col = 4, lty = 4, lwd = 3)
lines(cand.scale, log10(kls.xycoord.euclidean), type = "l", col = 5, lty = 5, lwd = 3)
...
sim3  <- simulation_nongrid(ordering = "maxmin", which.coord = NULL, conditioning = "NN", m = 10, scale.aniso = 10, n = 15^2, range = 0.1, covparms = c(1, 0.1, 0.5), nugget = 0)
...
sim.xycoord.nongrid <- repeated_simulation_nongrid(ordering = "coord", which.coord = c(1, 2), conditioning = "NN", 
                                                  ms = cand.m, scales = cand.scale,
                                                  n = 30^2, range = 0.1, covparms = c(1, 0.1, 0.5), nugget = 0)
...
# kls.xycoord.euclidean.nongrid   <- sim.xycoord.nongrid$kls[[1]][,3]
# kls.xycoord.corr.nongrid        <- sim.xycoord.nongrid$kls[[2]][,3] # non-sense
...
kls.legend <- c("Correlation + Maxmin         ",
                "Euclidean + Maxmin",
                "Euclidean + x-coord",
                "Euclidean + y-coord")
...
vis.list  <- c(kls.maxmin.euclidean.nongrid, kls.maxmin.corr.nongrid, kls.xcoord.euclidean.nongrid, kls.ycoord.euclidean.nongrid, kls.xycoord.euclidean.nongrid)
min.kls   <- min(vis.list)
max.kls   <- max(vis.list)

plot(cand.scale, log10(kls.maxmin.euclidean.nongrid), type = "l", col = 1, lty = 1, lwd = 2,
     ylim = c(log10(min.kls)-1, log10(max.kls)), 
     xlab = "scale.aniso", ylab = "log10(KL)", main = "m = 10")
lines(cand.scale, log10(kls.maxmin.corr.nongrid), type = "l", col = 2, lty = 2, lwd = 2)
lines(cand.scale, log10(kls.xcoord.euclidean.nongrid), type = "l", col = 3, lty = 3, lwd = 2)
lines(cand.scale, log10(kls.ycoord.euclidean.nongrid), type = "l", col = 4, lty = 4, lwd = 2)
lines(cand.scale, log10(kls.xycoord.euclidean.nongrid), type = "l", col = 5, lty = 5, lwd = 2)
legend("bottomleft", 
       legend=c("maxmin + Euclidean", "maxmin + correlation",
                "x-coord + Euclidean", "y-coord + Euclidean",
                "(x+y)-coord + Euclidean"),
       col=1:5, lty=1:5, lwd = 2, cex=0.8)
